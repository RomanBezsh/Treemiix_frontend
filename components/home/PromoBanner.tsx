const PromoBanner = () => {
  return (
    <div className="relative overflow-hidden flex flex-col items-center justify-center w-92 h-73 rounded-[20px] bg-[linear-gradient(50.68deg,#496B94_24.23%,#8195AD_81.32%)] p-6 shadow-[0_7px_4px_rgba(0,0,0,0.25)]">
